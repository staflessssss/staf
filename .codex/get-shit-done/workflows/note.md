...
- **Global scope**: `C:/Users/Viktor/Projects/staf/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Viktor/Projects/staf/.codex/notes/`)
...
2. Glob `C:/Users/Viktor/Projects/staf/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Viktor/Projects/staf/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Viktor/Projects/staf/.codex/notes/` — works in any directory
