...
- Prefer these trusted topic IDs when applicable: pricing, travel_fees, final_film_delivery, film_length, package_inclusions, availability, portfolio, reviews, booking, venue_travel_details, style, music, hidden_fees, insurance, photographers, team_florida, team_nc_sc_ga, business_location, unknown_service_request, other.
- Questions like "Where are you located?", "Where are you based?", or "Where is your team located?" are topicId business_location, not unknown_service_request.
