          ...
          <div className="flex h-full w-full max-w-[460px] flex-col border-l border-border bg-white shadow-[-24px_0_60px_rgba(31,23,40,0.14)]">
            <div className="flex items-start justify-between gap-4 border-b border-border px-5 py-4">
              <div className="flex items-start gap-3">
                <div className="flex size-12 items-center justify-center rounded-full border border-border bg-[#faf6f0] text-foreground">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Test chat</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <button
              ...
              {visibleMessages.length === 0 ? (
                ...
                visibleMessages.map((chatMessage) => (
                  ...
                  >
                    ...
                    {chatMessage.usedTooling?.length ? (
